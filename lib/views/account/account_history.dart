                            ...
                            FittedBox(
                              child:  Row(
                                children: const [
                                  ...
                                  SizedBox(width: 8,),
                                  Text("pts",style: TextStyle(fontSize: 13),),
                                ],
                              ),
                            ),
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children:  [
                            ...
                            Text("POINTS HISTORY",style: TextStyle(fontWeight: FontWeight.w800,fontSize: 22,color: Palette.color),),
                              ...
                              return Column(
                                children:  [
                                  ListTile(
                                    ...
                                    leading: Icon(SubaIcon.plus,color: Palette.color,),
                                    trailing: const Text(
                                      "+350",
                                      style: TextStyle(
                                          fontSize: 17, fontWeight: FontWeight.w800),
